        ...
        <div className="w-full h-full flex flex-col overflow-hidden">
            <div className="border-b items-center px-2 py-1.5 flex justify-between sticky top-0 z-10 bg-background shrink-0">
                ...
                <div className="flex gap-3 items-center">
                    <Link href="" className="hover:text-primary text-muted-foreground" aria-label="Edit">
                        <PencilIcon size={14} />
                    </Link>
                    <Link href="" className="hover:text-primary text-muted-foreground" aria-label="Settings">
                        <BoltIcon size={14} />
                    </Link>
                </div>
            </div>
